window.top.config = {
    Middler: {
        'VESH.view': {
            ...
            box: { type: '.Box', path: '../../VJ/2.0/VJ.view.extend.js' },
            ...
            rangepanel: { type: '.Panel', path: 'hammer.min.js;../../VJ/2.0/VJ.view.extend.js', params: ['', {}, 0.4, true] },
            pagepanel: {
                type: '.PagePanel',
                params: [
            ...
            isNumber: { type: 'VJ.view.Regex', params: ['/^((.{0,0})|([0-9]+\\.{0,1}[0-9]{0,2}))$/g'] },
            isInt: { type: 'VJ.view.Regex', params: ['/^((.{0,0})|([0-9]+))$/g'] },
            isLetter: { type: 'VJ.view.Regex', params: ['/^((.{0,0})|([A-Za-z]+))$/g'] },
            isPassword: { type: 'VJ.view.Regex', params: ['/^((.{0,0})|(([a-zA-Z]|\\w){5,17}))$/g'] },
            ...
            isQQ: { type: 'VJ.view.Regex', params: ['/^((.{0,0})|([1-9]\\d{4,12}))$/g'] },
            isZipCode: { type: 'VJ.view.Regex', params: ['/^((.{0,0})|([1-9]\\d{5}(?!\\d)))$/g'] },
            isIP: { type: 'VJ.view.Regex', params: ['/^((.{0,0})|(([\\d+\\.]{3}|[\\d+\\.]{5})\\d+))$/g'] },
            isCurreny: { type: 'VJ.view.Regex', params: ['/^((.{0,0})|(\\d+\\.\\d{2}))$/g'] }
        },
        'VESH.viewmodel': {
            pack: 'VJ.viewmodel',
            method: 'constructor',
